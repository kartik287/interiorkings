			...
			<div class="body" id="about">
				<div id="sidebar">
					<div class="body">
						...
						<div class="contact">
							<p>
								For Order and Inquiries Please Call: <b>999-091-2864</b> Or you can visit us at: <b>Showroom No. 7, Inner Circle, CP, New Delhi 110001</b>
							</p>
						</div>
					</div>
				</div>
				<div id="main">
					...
					<p>
						Woodsworth, Mintwud, Casacraft, Mudramark, Amberville, Mollycoddle, Bohemiana, Hometown, Cello, Kapoor E Illuminations, Fabuliv, Sleep Sutraa, @home, Exim Decor, Fos Lighting, JJ Sanitaryware, Bombay Dyeing, My Gift Booth, Gilson, Hosley, Jvs, KRM Decor, Fourwalls, Joyo Cera, Nilkamal, Godrej Interio, Malik Design, Zahab, Durian, SEJ By Nisha Gupta, Spacewood, Philips, Clouddio.
					</p>
