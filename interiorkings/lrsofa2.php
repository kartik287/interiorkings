			...
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						...
						<p>
							A contemporary sofa featuring beautiful new fabric ranges of super smooth tactile fabric through to luxurious chenille’s, mixing bold colours with geometric accents.
						</p>
						<span class="price">Rs.36,000</span>
					</li>

					<li>
						<div class="frame">
							<img src="images/sofa4.jpg" alt="Img">
						</div>
						<h5>Grand Grey Sofa</h5>
						<p>
							Structure in various woods, with the insertion into the base of special PVC slats that replace the traditional elastic bands making the seat last longer, more stable and more resistant. <a href="https://www.longhi.it/en-us/collections/loveluxe/sofas/mi">More details</a>
						</p>
						<span class="price">Rs.56,000</span>
					</li>
				</ul>
				<div id="pagination">
					<a href="livingroom.php" class="previous">Previous</a>
					<a href="lrsofa3.php" class="next">Next</a>
					<ul>
						<li>
							Pages:
						</li>
