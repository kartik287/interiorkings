			...
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						...
						<h5>Abstract Pattern Multicolour 6 X 4 Feet Nylon Carpet By Status</h5>
						<p>
							Want to make your guests feel special? Then welcome your guests in style by decorating your living area flooring with these abstract-patterned area rugs. Available in vibrant colours and designs, pick the one as per your needs and add to your living area's luxury. A one stop-shop for home decor and furniture.<br>
							<a href="https://www.pepperfry.com/abstract-pattern-multicolour-6-x-4-feet-nylon-carpet-by-status-1738825.html?type=clip&pos=1:1&catname=Carpets&total_result=1921&variation_id=203735">Check it out</a>
						</p>
						<span class="price">Rs.1,429</span>
					</li>
					<li>
						<div class="ak">
							<img src="images/cp2.jpg" alt="Img">
						</div>
						<h5>Blue Abstract Pattern Machine Made Nylon Carpet 5 x 3 feet by Status</h5>
						<p>
							Status 3D Printed Vintage Persian Carpet Rug Runner for Bedroom/Living Area/Home with Anti Slip Backing (3x5 Feet-Small, Multi)-Pack of 1 A one stop-shop for home decor and furniture. So go ahead and buy with confidence.<br>
							<a href="https://www.pepperfry.com/blue-nylon-3x5-ft-abstract-pattern-carpet-by-status-1778588.html?type=clip&pos=3:1&catname=Carpets&total_result=1921&variation_id=203735">Check it out</a>
						</p>
						<span class="price">Rs.1,029</span>
					</li>
				</ul>
				<div id="pagination">
					<a href="carpet.php" class="previous">Previous</a>
					<a href="cp2.php" class="next">Next</a>
					<ul>
						<li>
							Pages:
						</li>
						<li class="selected">
							<a href="carpet.php">1</a>
						</li>
						<li>
							<a href="cp2.php">2</a>
						</li>
