			...
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						...
						<h5>Cecelia Wing Chair in Red Colour by CasaCraft</h5>
						<p>
					...
					<li>
						...
						<h5>David Wing Chair in Teal Colour by CasaCraft</h5>
						<p>
							Wing Chairs are sculptural, imposing classic chairs with high backs that curve inwards at the end like wings and having plush armrest which add to the comfort and general appeal.
						</p>
						<div class="details">
							<h5>Details</h5>
							<p>
				...
				<div id="pagination">
					<a href="chair.php" class="previous">Previous</a>
					<a href="chair2.php" class="next">Next</a>
					<ul>
						<li>
							Pages:
						</li>
						<li class="selected">
							<a href="chair.php">1</a>
						</li>
						<li>
							<a href="chair2.php">2</a>
						</li>
						<li>
							<a href="chair3.php">3</a>
						</li>
