			...
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						...
						<h5>Freddie 3 Seater Teal Sofa</h5>
						<p>
							Featuring a retro inspired, modern design as seen with the Freddies soft curved shape and buttoned back seat which has been upholstered in a soft teal sofa.<br>
							<a href="https://www.woods-furniture.co.uk/freddie-3-seater-teal-sofa/p8037">Check it out</a>
						</p>
						<span class="price">Rs.42,875</span>
					</li>
					<li>
						<div class="frame">
							<img src="images/sofa3.jpg" alt="Img">
						</div>
						<h5>Margo Grand Sofa</h5>
						<p>
							A contemporary sofa featuring beautiful new fabric ranges of super smooth tactile fabric through to luxurious chenille’s, mixing bold colours with geometric accents. The streamlined design, finished with angular polished metal or wooden legs will suit the contemporary home whilst the deep button back is perfect to sink in to. The Jerry Accent chair with its angular arm detailing works in harmony with the fabrics and legs of this sofa.   <a href="https://www.huntersfurniture.co.uk/margo-grand-sofa/p4506">Check it out</a>
						</p>
						<span class="price">Rs.84,975</span>
					</li>
				</ul>
				<div id="pagination">
					<a href="livingroom.php" class="previous">Previous</a>
					<a href="lrsofa2.php" class="next">Next</a>
					<ul>
						<li>
							Pages:
						</li>
						<li class="selected">
							<a href="livingroom.php">1</a>
						</li>
						<li>
							<a href="lrsofa2.php">2</a>
						</li>
						<li>
							<a href="lrsofa3.php">3</a>
						</li>
					</ul>
				</div>
			</div>
